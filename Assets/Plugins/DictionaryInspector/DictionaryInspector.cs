...
[Serializable]
public class DictionaryInspector<TKey, TValue> : IReadOnlyDictionary<TKey, TValue>, IDictionary<TKey, TValue>,
    ISerializationCallbackReceiver, IEnumerable
{
    ...
    public bool TryAdd(TKey key, TValue value)
    {
        ...
        {
            dictionaryCells.Add(new DictionaryCell(key, value));
            return true;
        }
    ...
    public bool Remove(TKey key)
    {
        ...
        {
            var removeIndex = dictionaryCells.FindIndex(v => v.key.Equals(key));
            dictionaryCells.RemoveAt(removeIndex);
            return true;
        }
    ...
    public bool Remove(TKey key, out TValue value)
    {
        ...
        {
            var removeIndex = dictionaryCells.FindIndex(c => c.key.Equals(key));
            dictionaryCells.RemoveAt(removeIndex);
            return true;
        }
    ...
    public void Add(KeyValuePair<TKey, TValue> item)
    {
        ...
        dictionaryCells.Add(new DictionaryCell(item.Key, item.Value));
    }
    ...
    public bool Remove(KeyValuePair<TKey, TValue> item)
    {
        ...
        {
            dictionaryCells.RemoveAt(dictionaryCells.FindIndex(c => c.key.Equals(item.Key)));
